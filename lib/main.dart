        ...
        children: [
          ...
          Row(
            children: [
              ...
              // Main Content
              Padding(
                padding: const EdgeInsets.only(top: 108, left: 64),
                child: Container(
                  height: 890,
                  // width: 1568,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          // Tax Info
                          SizedBox(
                            width: 340, // or any width you want
                            child: _TaxInfoForm(),
                          ),
                          const SizedBox(width: 32),
                          // Reference Images
                          SizedBox(
                            width: 240, // or any width you want
            ...
            children: [
              ...
              Flexible(
                ...
                child: _LabeledField(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: _TextField(hint: "Rocket")),
                      const SizedBox(width: 8),
                      TextButton(
                        onPressed: () {},
              ...
              Flexible(
                ...
                child: _LabeledField(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: _TextField(hint: "Pocket//'")),
                      const SizedBox(width: 8),
                      TextButton(
                        onPressed: () {},
              ...
              const SizedBox(width: 16),
              _LabeledField(label: "Note", child: _TextField(hint: "Fnifinf")),
              const SizedBox(height: 16),
            ],
          ),
            ...
            children: [
              ...
              Flexible(
                ...
                child: _LabeledField(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: _TextField(hint: "20,000,000 Rs.")),
                      const SizedBox(width: 8),
                      TextButton(
                        onPressed: () {},
              ...
              Flexible(
                ...
                child: _LabeledField(
                  label: "Product Code",
                  child: _TextField(hint: "SGMW-24-001 - Auto Generated"),
                ),
              ),
              const SizedBox(height: 16),
              Flexible(
